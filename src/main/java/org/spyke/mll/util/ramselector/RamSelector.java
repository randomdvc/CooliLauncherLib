...
public class RamSelector
{
    ...
    public JFrame display()
    {
        if (frame == null)
            ...
            {
                System.err.println("[minecraftlauncherlibrary] Can't display the Ram Selector !");
                System.err.println(CrashReporter.makeCrashReport("minecraftlauncherlibrary Ram Selector", e));
    ...
    private int readRam()
    {
        ...
        {
            System.err.println("[minecraftlauncherlibrary] WARNING: Can't read ram : " + e);
        }
        finally
        {
            if (br != null)
                ...
                {
                    System.err.println("[minecraftlauncherlibrary] WARNING: Can't close the file : " + e);
                }
        }
	...
	if (frame == null)
        ...
        {
            System.err.println("[minecraftlauncherlibrary] WARNING: Can't save ram : " + e);
        }
        finally
        {
            if (bw != null)
