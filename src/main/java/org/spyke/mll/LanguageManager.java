/*
 * Copyright 2015-2017 Riane "spykedev" Navratil
 *
 * This file is part of the minecraftlauncherlibrary.

 * The minecraftlauncherlibrary is free software: you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * The minecraftlauncherlibrary is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * GNU Lesser General Public License for more details.
 *
 * You should have received a copy of the GNU Lesser General Public License
 * along with the minecraftlauncherlibrary.  If not, see <http://www.gnu.org/licenses/>.
 */
...
public class LanguageManager
{
    ...
    static
    {
        ENGLISH.put("hi-int", "CooliLauncher Bêta 1.0.0 by RLDevelopement 'spykedev'");
        ENGLISH.put("hi-ext", "CooliLauncher Bêta 1.0.0 by RLDevelopement 'spykedev'");
        ...
        ENGLISH.put("mc-int", "Creating profile for Cooli");
        ENGLISH.put("mc-ext", "Creating profile for Cooli");
        ...
        ENGLISH.put("support-forge", "CooliForge is a Private Library");
        ...
        FRENCH.put("hi-int", "CooliLauncher Bêta 1.0.0 par RLDevelopement 'spykedev'");
        FRENCH.put("hi-ext", "CooliLauncher Bêta 1.0.0 par RLDevelopement 'spykedev'");
        ...
        FRENCH.put("mc-int", "Creation d'un profil pour Cooli");
        FRENCH.put("mc-ext", "Creation d'un profil pour Cooli");
		...
		FRENCH.put("support-forge", "CooliForge est une librairie privée");
