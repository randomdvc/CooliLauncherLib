...
public class LanguageManager
{
    ...
    static
    {
        ENGLISH.put("hi-int", "CooliLauncher Bêta 1.0.0 by Riane 'spykedev'");
        ENGLISH.put("hi-ext", "CooliLauncher Bêta 1.0.0 by Riane 'spykedev'");
        ...
        FRENCH.put("hi-int", "CooliLauncher Bêta 1.0.0 par Riane 'spykedev'");
        FRENCH.put("hi-ext", "CooliLauncher Bêta 1.0.0 par Riane 'spykedev'");
